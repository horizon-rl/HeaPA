...
# ---- experiment names --------------------------------------------------------
project_name='HEAP-DAPO-Main'
exp_name='Qwen25-7B-ins_14kdapo_wAug-wTeacher-16rollout-20kresponse'
...
RAY_OVERRIDE_JOB_RUNTIME_ENV=1 ray job submit --no-wait --runtime-env="${RUNTIME_ENV}" \
