...
# ---- experiment names --------------------------------------------------------
project_name='HEAP-DAPO-RewardRefresh-Main'
exp_name='Qwen25-7B-ins_14kdapo_wAug-wTeacher-wRewardRefresh-ChildrenAggregation_16rollout-20kresponse'
...
TRAIN_FILE="['/home/greenland-user/verl/data/fullset_14k-dapo-math-refreshReward.parquet']"
TEST_FILE="['/home/greenland-user/verl/data/aime-2024-960.parquet']"

ray job submit --no-wait --runtime-env="${RUNTIME_ENV}" \
--working-dir "${WORKING_DIR}" \
--address "${RAY_ADDRESS}" \
-- python3 -m recipe.dapo.main_dapo_augment_reward_propagation \
...
+dynamic_data.aug_delay_steps=5 \
+dynamic_data.refresh_reward="children_aggregation" \
