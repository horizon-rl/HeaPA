...
# ---- experiment names --------------------------------------------------------
project_name='DAPO_original_Qwen25_7B_instruct'
exp_name='DAPO-Qwen25-7B-instruct-disable-heap-aug_ablation'
...
TRAIN_FILE="['/home/greenland-user/verl/data/dapo-math-17k-no_chinese.parquet']"
...
+dynamic_data.sampling_mode="mixed_easy_medium" \
