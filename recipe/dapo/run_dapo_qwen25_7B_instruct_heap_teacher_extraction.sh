...
# ---- experiment names --------------------------------------------------------
project_name='DAPO_heap_Qwen25-7B-teacher-extraction'
exp_name='gpt5-mini_teacher_extraction_uniform-difficulty_medium-only_collect-aug-query_2node_group2'
